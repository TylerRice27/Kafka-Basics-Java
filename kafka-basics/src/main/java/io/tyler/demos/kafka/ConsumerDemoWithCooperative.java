...
//        This GroupId correlates to the Group Variable that I have up above right below my Main()
...
//        properties.setProperty("group.instance.id", "...Value") // Strategy for static assignments
